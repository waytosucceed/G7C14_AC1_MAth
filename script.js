document.addEventListener('DOMContentLoaded', () => {
    ...
    // Create two containers for options
    const optionContainer1 = document.createElement('div');
    optionContainer1.classList.add('option-container');
    const optionContainer2 = document.createElement('div');
    optionContainer2.classList.add('option-container');
    ...
    question.options.forEach((option, index) => {
      ...
      if (index % 2 === 0) {
        optionContainer1.appendChild(imgButton);
      } else {
        optionContainer2.appendChild(imgButton);
      }
    });
    ...
    answerButtonsElement.appendChild(optionContainer2);
            ...
            // Otherwise, assume text options (your existing button creation logic)
            const rightContainer = document.querySelector('.right-container');
        rightContainer.innerHTML = '';
    ...
    function showCompletionMessage() {
        ...
        questionElement.innerText = "Well done, you have learnt about Points, Lines and Angles";
        questionNumbersElement.innerHTML = '';
    ...
    //     const selectedIndex = Array.from(answerButtonsElement.children).indexOf(selectedButton);
